            ...
            <div className="container">
                <div className="heading py-10 px-5 flex flex-col md:px-[25rem]">
                    <div className="">
                        ...
                        <div className="py-10">
                    <h3 className="md:text-[23px] text-[16px] leading-[30px] font-[600] text-[#004a8b]  m-1">LAWD has an outstanding track record of connecting premium buyers with specialist Australian real estate across development sites, institutional grade assets, corporate farms, downstream processing facilities, family farms and lifestyle properties.</h3>
                </div>
                </div>
